...
export default async function AdminGalleryPage() {
  ...
  return (
    <div>
      <PageHeader title="Kelola Galeri" description="Karya berstatus PUBLISHED akan tampil di galeri siswa." />
      {works.length ? (
        ...
        <EmptyState title="Galeri masih kosong" description="Publikasikan karya dari halaman review agar tampil di sini." />
      )}
    </div>
  );
}
